...
// EDEXCEL GCSE GRADE BOUNDARIES 2026 — DEDICATED PAGE
...
// ─────────────────────────────────────────────
// SEO METADATA
// Title: 53 chars — single year, front-loaded keyword, no truncation
// Description: specific hook + CTA, not generic
// ─────────────────────────────────────────────
export const metadata: Metadata = {
  title: 'Edexcel GCSE Grade Boundaries 2026 | Raw Mark Calculator',
  description:
    'Enter your raw mark → see your Edexcel GCSE grade in 3 seconds. Official Pearson boundaries 2026 for Maths, English, Biology, Chemistry, Physics, History, Geography and more. No signup. Updates live 20 August 2026.',
  keywords: [
    'edexcel grade boundaries 2026',
    'edexcel gcse grade boundaries 2026',
    'edexcel grade boundaries',
    'edexcel gcse grade boundaries',
    'edexcel grade boundaries maths 2026',
    'edexcel grade boundaries english 2026',
    'edexcel grade boundaries biology 2026',
    'edexcel grade boundaries chemistry 2026',
    'edexcel grade boundaries physics 2026',
    'edexcel grade boundaries calculator',
    'pearson edexcel grade boundaries 2026',
    ...
    'edexcel gcse grade boundaries history',
    'edexcel gcse grade boundaries geography',
    'edexcel gcse grade 9 boundary 2026',
    'edexcel gcse grade 4 boundary 2026',
    'edexcel raw mark grade boundaries',
    'what percentage is grade 9 edexcel gcse',
    'edexcel gcse results day 2026',
  ],
  alternates: { canonical: 'https://gradesnova.com/exams/gcse/edexcel' },
  openGraph: {
    title: 'Edexcel GCSE Grade Boundaries 2026 | Raw Mark Calculator',
    description:
      'Enter your Edexcel raw mark → get your GCSE grade instantly. All subjects. Official Pearson 2025 data, updated live 20 August 2026 on Results Day.',
...
// ─────────────────────────────────────────────
// STRUCTURED DATA — 4 schemas for rich results + GEO/AI citation
// Dataset.isBasedOn links to Pearson official docs for AI/LLM trust
// ─────────────────────────────────────────────
const jsonLdBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Edexcel Grade Boundaries 2026', item: 'https://gradesnova.com/exams/gcse/edexcel' },
  ],
};
...
const jsonLdTool = {
  '@context': 'https://schema.org',
  '@type': 'WebApplication',
  name: 'Edexcel GCSE Grade Boundaries Calculator 2026',
  url: 'https://gradesnova.com/exams/gcse/edexcel',
  description:
    'Free Edexcel GCSE grade boundaries calculator 2026. Enter any raw mark to instantly find your Pearson Edexcel grade for Maths, English, Biology, Chemistry, Physics and more.',
...
const jsonLdDataset = {
  '@context': 'https://schema.org',
  '@type': 'Dataset',
  name: 'Edexcel GCSE Grade Boundaries 2026',
  description:
  ...
  dateModified: '2026-05-26',
  keywords: 'Edexcel, Pearson, GCSE, grade boundaries, 2026, raw marks',
  isBasedOn: {
    '@type': 'CreativeWork',
...
const jsonLdFAQ = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'What are the Edexcel GCSE grade boundaries for 2026?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Edexcel 2026 GCSE grade boundaries will be published at 8:00am on Thursday 20 August 2026 (GCSE Results Day). The 2025 Edexcel boundaries shown here are the most recent official data. GradesNova updates immediately when 2026 Edexcel data is released by Pearson.',
      },
    },
    {
      '@type': 'Question',
      name: 'What is the Edexcel grade 9 boundary for GCSE Maths 2026?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'In 2025, the Edexcel GCSE Maths Higher grade 9 boundary was 217 out of 240 (90.4%). The 2026 boundary will be confirmed on Results Day 20 August 2026. Based on 2022–2025 trends, expect the 2026 Edexcel Maths grade 9 to fall in the range of 210–225 out of 240.',
      },
    },
    {
      '@type': 'Question',
      name: 'What is the Edexcel GCSE Maths grade 4 pass mark?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pearson Edexcel publishes 2026 GCSE grade boundaries at exactly 8:00am on Thursday 20 August 2026. This is the same time as all other boards (AQA, OCR, WJEC). They are strictly embargoed before this date.',
      },
    },
    {
      '@type': 'Question',
      name: 'What is the Edexcel GCSE grade 5 strong pass boundary for Maths?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'In 2025, the Edexcel Maths Higher grade 5 (strong pass) boundary was 87 out of 240 (36%). For Foundation tier it was 175 out of 240 (73%). Grade 5 is the strong pass typically required by sixth forms for A-Level Maths entry.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'This depends on the difficulty of the 2026 Edexcel papers. Ofqual uses a comparable outcomes process to prevent large year-on-year changes. Based on the 2022–2025 trend (grade 4 ranging from 48–53), a moderate change in 2026 would be typical. The 2026 boundary will be confirmed on Results Day 20 August 2026.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Add up your raw marks from all papers for the subject. For Edexcel Maths Higher, you have 3 papers totalling 240 marks. Compare the total to the boundary table above. If your total is 217 or above, you achieved grade 9 in 2025. If it is 53–86, you achieved grade 4.',
      },
    },
  ],
};
...
// ─────────────────────────────────────────────
// DATA — verified against official Pearson Edexcel June 2025 documents
// ─────────────────────────────────────────────
...
const CROSS_BOARD_2025 = [
  ...
  { label: 'OCR Maths Higher',            g9: 210, g5: 84, g4: 51, max: 240, color: '#a855f7' },
  ...
  { label: 'OCR English Language',        g9: 115, g5: 79, g4: 69, max: 160, color: '#a855f7' },
  ...
  { label: 'OCR Chemistry Higher',        g9: 153, g5: 69, g4: 44, max: 200, color: '#a855f7' },
];
...
export default function EdexcelGCSEPage() {
  return (
    <>
      {/* All 4 schemas injected above the fold */}
      ...
      <main className="bg-[#0a0c14] min-h-screen text-white">
        ...
        <header className="bg-[#0d0f1a] border-b border-white/6 py-10 mt-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* H1 — single year, front-loaded, <60 chars */}
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <span className="text-xs bg-white/5 text-slate-400 border border-white/10 px-3 py-1 rounded-full">Source: qualifications.pearson.com official documents</span>
            </div>

            <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
              Official Pearson Edexcel GCSE grade boundaries for all subjects. Enter your raw mark to find your grade instantly.
              Covers Maths, English Language, English Literature, Biology, Chemistry, Physics, History, Geography, Computer Science and more.
              Showing <strong className="text-white">Edexcel June 2025 boundaries</strong> — the most recent official data.{' '}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
          ...
          {/* ══════════════════════════════════════
              QUICK FACTS — 4 most-searched boundaries
          ══════════════════════════════════════ */}
          ...
          <div className="bg-indigo-500/10 border border-indigo-500/25 rounded-2xl p-6 flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                ...
                GradesNova updates this calculator with live Edexcel 2026 data the moment the official boundary documents are released.
              </p>
            </div>
          </div>
          ...
          {/* ══════════════════════════════════════
              MAIN BOUNDARY TABLE
              Fully visible — NOT hidden in JS accordion
          ══════════════════════════════════════ */}
          <section aria-labelledby="edexcel-table-heading">
            ...
            <p className="text-xs text-slate-600 mt-3">
              ...
              Verified against qualifications.pearson.com official documents, 26 May 2026.
              GradesNova is not affiliated with Pearson Edexcel.
            </p>
          </section>
          ...
          <section aria-labelledby="edexcel-maths-yoy-heading">
            ...
            <p className="text-slate-400 text-sm mb-6">
              Four-year trend for Edexcel GCSE Maths Higher tier. Edexcel boundaries have risen steadily since 2022 as
              ...
              <table className="w-full text-sm min-w-[500px]" aria-label="Edexcel GCSE Maths Higher grade boundaries 2022 to 2025 year on year">
                ...
                <tbody>
                  {EDEXCEL_MATHS_YOY.map((row, i) => (
                    <tr
                      key={row.year}
                      className={`border-b border-white/5 last:border-0 ${i === 0 ? 'bg-indigo-500/5' : i % 2 !== 0 ? 'bg-white/2' : ''}`}
                    >
                      <td className="px-4 py-3 font-mono font-semibold text-white">
                        {row.year}
                        {i === 0 && (
                          <span className="ml-2 text-[10px] bg-indigo-500/20 text-indigo-300 px-1.5 py-0.5 rounded font-sans">
                            latest
                          </span>
                        )}
                      </td>
          ...
          {/* ══════════════════════════════════════
              ...
              Now includes OCR — expanded from original
          ══════════════════════════════════════ */}
          <section aria-labelledby="edexcel-vs-boards-heading">
            ...
            <p className="text-slate-400 text-sm mb-6">
              ...
              <strong className="text-white">53 out of 240 for grade 4</strong> — 10 marks below AQA (63) and 2 below OCR (51).
            ...
            <div className="mt-4 bg-amber-500/10 border border-amber-500/20 rounded-xl px-4 py-3 flex gap-3 items-start">
              ...
              <p className="text-sm text-slate-300">
                ...
                Edexcel Maths Higher grade 4 was 53/240 in 2025, while AQA was 63/240 — a 10-mark difference.
          ...
          {/* ══════════════════════════════════════
              ...
              Targets "what is edexcel grade 9 percentage" etc.
          ══════════════════════════════════════ */}
          <section aria-labelledby="grade-scale-heading">
            ...
            <p className="text-slate-400 leading-relaxed mb-5">
              All GCSE boards — including Edexcel — use the same 9–1 grading scale, introduced to replace the old A*–G system.
              Grade descriptors are consistent across Edexcel, AQA, OCR, and WJEC.
            </p>
              ...
              <table className="w-full text-sm min-w-[480px]" aria-label="Edexcel GCSE 9 to 1 grade scale with old grade equivalents and benchmarks">
                ...
                <tbody className="divide-y divide-white/5">
                  {[
                    ...
                    { grade: '4', old: 'C',                 desc: 'Standard pass +',       bench: 'Minimum for employers and most colleges',   color: '#f59e0b' },
            ...
            <p className="text-xs text-slate-600 mt-3">
              Source: Ofqual GCSE grade descriptors (2024). Equivalences are approximate.
            </p>
          </section>

          {/* ══════════════════════════════════════
              FAQ — native <details>/<summary> for crawlability
              8 questions, each targeting a distinct featured snippet
          ══════════════════════════════════════ */}
          <section aria-labelledby="faq-heading">
            <h2 id="faq-heading" className="text-2xl font-bold text-white mb-2">
              Edexcel GCSE grade boundaries 2026 — frequently asked questions
            </h2>
            <p className="text-slate-400 text-sm mb-6">
            ...
            <div className="space-y-3">
              {[
                {
                  q: 'What are the Edexcel GCSE grade boundaries for 2026?',
                  a: 'Pearson Edexcel publishes 2026 GCSE grade boundaries at 8:00am on Thursday 20 August 2026 (Results Day). Until then, the 2025 Edexcel boundaries on this page are the best available reference. GradesNova updates with live 2026 Edexcel data the moment it is released by Pearson.',
                },
                {
                ...
                },
                {
                  ...
                  a: 'In 2025, Edexcel Maths Higher grade 4 was 53/240 while AQA Maths Higher grade 4 was 63/240 — Edexcel required 10 fewer marks for a standard pass. This reflects differences in paper difficulty between the two boards. Both are equivalent grade 4 standards.',
                },
                {
                  q: 'When does Edexcel publish 2026 GCSE grade boundaries?',
                  a: 'Pearson Edexcel publishes all 2026 GCSE grade boundaries at exactly 8:00am on Thursday 20 August 2026 (GCSE Results Day). This is the same time as AQA, OCR, and WJEC. Boundaries are strictly embargoed before this date.',
                },
                {
                ...
                },
                {
                  ...
                  a: 'Add up your raw marks from all papers for the subject. For Edexcel Maths Higher, you have 3 papers totalling 240 marks. Compare the total to the boundary table above. If your total is 217 or above, you achieved grade 9. If it is 53–86, you achieved grade 4.',
                },
                {
                  q: 'What is the difference between Edexcel Foundation and Higher tier boundaries?',
                  a: 'Foundation tier is capped at grade 5 and targeted at students expecting grades 1–5. Higher tier is targeted at grades 4–9. Foundation tier boundaries are set differently and generally require a higher percentage of the paper for each grade because the questions are more straightforward. For Maths Foundation in 2025, grade 4 required 144 out of 240 (60%), compared to 53 out of 240 (22%) on Higher tier.',
                },
              ].map((faq, i) => (
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    ...
                    Year-on-year Maths data (2022–2025) was cross-referenced against archived Edexcel boundary releases.
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    ...
                    data as soon as the Pearson documents are publicly released. During the update window, both 2025
                    and 2026 data are shown with clear year labels.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* ══════════════════════════════════════
              OTHER BOARDS — internal links + PageRank
          ══════════════════════════════════════ */}
          <section aria-labelledby="other-boards-heading">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { name: 'All Boards — GCSE 2026',     href: '/exams/gcse',         color: '#6366f1' },
              ].map(b => (
                <Link
                  key={b.name}
                  href={b.href}
